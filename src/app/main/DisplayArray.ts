...
export class DisplayArray{
    ...
    populateList(recordNumber: number, catArray: Category[], supArray: Supplier[], prodArray: Product[]): void{
        ...
        record1.setId(v1 + 1);
        record1.setProductName(prodArray[v1].product_name);
        ...
        record2.setId(v2 + 1);
        record2.setProductName(prodArray[v2].product_name);
        ...
        record3.setId(v3 + 1);
        record3.setProductName(prodArray[v3].product_name);
        ...
        record4.setId(v4 + 1);
        record4.setProductName(prodArray[v4].product_name);
        ...
        record5.setId(v5 + 1);
        record5.setProductName(prodArray[v5].product_name);
        ...
        record6.setId(v6 + 1);
        record6.setProductName(prodArray[v6].product_name);
        ...
        record7.setId(v7 + 1);
        record7.setProductName(prodArray[v7].product_name);
        ...
        record8.setId(v8 + 1);
        record8.setProductName(prodArray[v8].product_name);
